...
VALUES
('Max','Müller','maxmüller','passwort1','max.mueller@berlin.de',123456789,NULL,'A1.01',NULL,1),
('Susanne','Schmidt','susanneschmidt','passwort2','susanne.schmidt@berlin.de',987654321,NULL,'A2.01',NULL,2);

INSERT INTO Proband(Vorname, Nachname, UserName, Passwort, Email, Telnr, Aktenzeichen, Betreuungsanfang, Betreuungsende, BID)
VALUES
('Norbert','Meyer','norbertmeyer','passwort3','n.meyer@gmx.de',555666777,NULL,'2019-02-15','2019-08-15',1),
('Robert','Hansen','roberthansen','passwort4','roha@1und1.de',111222333,NULL,'2019-01-09','2019-07-03',1),
('Klaus','Schoppe','klausschoppe','passwort5','kschoppe@gmx.de',88225566,NULL,'2019-04-15','2019-10-10',2),
('Herbert','Kling','herbertkling','passwort6','hekli@googlemail.com',121255577,NULL,'2019-05-02','2019-11-20',2);
